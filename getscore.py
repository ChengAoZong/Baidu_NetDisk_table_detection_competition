...
def getscore(model, dataset_path, device):
    ...
    print(f'landmarks precision is {landmarks_TP}/{landmarks_TP + landmarks_FP} = {precision_landmarks}\n'
          ...
          f'bbox recall is {bbox_TP}/{total_bbox} = {recall_bbox}\n'
          f'final score is {final_score}\n')
...
if __name__ == '__main__':
    ...
    weights = 'runs\\train\\exp42\\weights\\last.pt'
    # cfg_path = '.\\models\\yolov5s.yaml'
    model = load_model(weights, device)
    # root = '/home/xialuxi/work/dukto/data/CCPD2020/CCPD2020/images/test/'
    dataset_path = "D:\\competion\\detection\\train\\dataset\\test\\"
    dataset_path = "D:\\competion\\tabel_detection\\newdataset\\res\\"
    #dataset_path = "D:\\competion\\detection\\train\\pubtest\\"
