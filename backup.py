...
from utils.general import check_img_size, non_max_suppression_landmark, apply_classifier, scale_coords, xyxy2xywh, \
    strip_optimizer, set_logging, increment_path, bbox_iou
...
def detect_one(model, image_path, device):
    ...
    orgimg = cv2.resize(orgimg, (1080, 720))
...
def getscore(model, image_path, device):
    image_list = ['D:\\competion\\detection\\train\\images\\IMG_3070.jpg',
                  'D:\\competion\\detection\\train\\images\\border_0_00BQSK4CJMM5K3UM477Z.jpg']
    label_list = ['D:\\competion\\detection\\train\\labels\\IMG_3070.txt',
                  'D:\\competion\\detection\\train\\labels\\border_0_00BQSK4CJMM5K3UM477Z.txt']
    # image_list = ['D:\\competion\\detection\\train\\images\\border_0_00BQSK4CJMM5K3UM477Z.jpg']
    # label_list = ['D:\\competion\\detection\\train\\labels\\border_0_00BQSK4CJMM5K3UM477Z.txt']
    # image_list = ['D:\\competion\\detection\\train\\images\\IMG_3070.jpg']
    # label_list = ['D:\\competion\\detection\\train\\labels\\IMG_3070.txt']
    landmarks_TP = 0
    landmarks_FP = 0
    ...
    for k, item in enumerate(image_list):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for i in range(len(true_det)):
                true_box_xywh.append(
                    [w0 * true_det[i][1], h0 * true_det[i][2], w0 * true_det[i][3], h0 * true_det[i][4]])
            ...
            if len(det) == len(true_det):
                total_landmarks = total_landmarks + 4
...
if __name__ == '__main__':
    ...
    image_path = 'D:\\competion\\detection\\train\\images\\border_0_00BQSK4CJMM5K3UM477Z.jpg'
    # image_path = 'D:\\competion\\detection\\train\\images\\border_0_99AKJRESXIYVLCNB4EK6.jpg'
    image_path = 'D:\\competion\\detection\\train\\images\\IMG_3087.jpg'
    image_path = 'D:\\competion\\detection\\train\\images\\IMG_3090.jpg'
    # detect_one(model, image_path, device)
    getscore(model, image_path, device)
    print('over')
